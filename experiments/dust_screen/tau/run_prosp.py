...
def log_masses_to_mass(logmass=None, **extras):
    return 10**logmass
...
model_params.append({'name': "sfh", "N": 1, "isfree": False, "init": 4, "units": "FSPS index"})


model_params.append({'name': "mass", 'N': 3, 'isfree': False, 'init': 1., 'units': r'M$_\odot$',
                          'depends_on':log_masses_to_mass})
...
model_params.append({'name': 'tage', 'N': 1,
                             'isfree': True,
                     'init': 5,
                     'prior': priors.TopHat(mini=0.1, maxi=14.1)})
...
def build_model(**kwargs):
    ...
    model_params[n.index('massmet')]['prior'] = MassMet(z_mini=-1.6, z_maxi=0.19, mass_mini=7.5, mass_maxi=13)
...
def build_obs(**kwargs):
    ...
    m = ModelOutput("/ufrc/narayanan/s.lower/pd_runs/simba_m25n512/snap305_dustscreen/snap305/snap305.galaxy"+str(sys.argv[1])+".rtout.sed")
...
if __name__ == '__main__':
    ...
    hfile = "/ufrc/narayanan/s.lower/simSEDs/simbam25n512_newfof/experiments/dust_screen/tau/galaxy"+sys.argv[1]+".h5"
