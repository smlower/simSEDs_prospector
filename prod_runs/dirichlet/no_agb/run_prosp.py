...
model_params.append({'name': 'dust2', 'N': 1,
                        ...
                        'disp_floor': 0.15,
                        'units': '',
                        'prior': priors.ClippedNormal(mini=0.0, maxi=1.5, mean=0.3, sigma=1)})
...
def build_obs(**kwargs):
    ...
    m = ModelOutput("/ufrc/narayanan/s.lower/pd_runs/simba_m25n512/snap305/mist_pd/snap305/snap305.galaxy"+"{:03d}".format(int(sys.argv[1]))+".rtout.sed")
...
if __name__ == '__main__':
    ...
    hfile = "/ufrc/narayanan/s.lower/simSEDs/simbam25n512_newfof/prod_runs/dirichlet/no_agb/galaxy"+sys.argv[1]+".h5"
